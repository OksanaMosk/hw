...
type ProductProps = {
  ...
  export const ProductComponent: FC<ProductProps> = ({ product }) => {
    ...
    return (
      <div className="flex flex-col justify-between w-[650px] gap-2 text-[#404214] box-border bg-[#eef0d3] hover:text-white hover:bg-[#badd86] p-4 shadow-xl rounded-xl cursor-pointer hover:shadow-2xl hover:border-[1px] m-10">
